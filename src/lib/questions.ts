// The Aligned question bank — 270 questions across 19 categories.
// EXTRACTED VERBATIM from legacy/index.html (the DATA object). Do not hand-edit
// here; the .xlsx workbook + HTML viewer remain the canonical source, and this
// file is regenerated from the bank. See CLAUDE.md §9.
